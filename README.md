...
2. **소장현황 데이터 사이트** — Omeka 전수 111,106건을 컬렉션·시간·주제·지역·키워드로 분석한 공개 사이트와 그 데이터
...
├─ data/
│   ├─ holdings/    소장현황 사이트 데이터 (Omeka 전수 집계 JSON 17종)
...
| 폴더 | 내용 |
|---|---|
| `raw/` | Google Analytics 원자료 엑셀 (풀숲 2025-26, 환경사진아카이브 2021-26) |
...
공간풀숲 전시 기록 가운데 관람객 후기·방명록·SNS 댓글이 담긴 파일은 개인 식별 표현을 검토한 뒤 공개하기로 하고 이 저장소에 넣지 않았습니다.
