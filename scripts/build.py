...
FILES=[("REPORT","환경아카이브 풀숲·환경사진아카이브·공간풀숲 임팩트 측정 보고서 v1.1 (PDF, 62쪽, 4.3MB, 2026-10-01 발행)"),("summary.json","핵심 수치"),("holdings.json","유형·형태·연도·주제·지역·품질·등록 추이"),("collections.json","컬렉션 34개 상세(유형·연도·주제·지역·키워드·생산자·품질·예시)"),("keywords_windows.json","5년 단위 상위·특징 키워드"),("keywords_series.json","상위 400 키워드의 연도별 건수"),("keywords_life.json","키워드 등장·정점·퇴장"),("keywords_change.json","연대 간 급상승·급락"),("keywords_cooc.json","공출현 네트워크"),("keywords_dict.json","키워드 사전(3건 이상)"),("org_keywords.json","단체 × 공통 키워드"),("network.json","생산자→기증주체, 공공기관 문서"),("events.json","사건 47건"),("orgs.json","조직 전거 542건"),("chronology.json","연표 집계"),("photos.json","작품사진 집계"),("season.json","생산 월 분포")]
